...
- **Workflow name**: Homelab repo collector
  ...
  - **Excluded**: `compose/paperless/docker-compose.yml`; all `.env` files; live service data (databases, volumes). `compose/paperless/docker-compose.yml` is not yet on the allowlist; a decision on adding it is pending.
