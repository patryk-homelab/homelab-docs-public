...
| Shlink | `shlink` | 8080 | `192.168.10.12:8087` / `http://192.168.10.12:8087/` | Sole private admin/API: `https://s.xdxd.uk/`; sole live public short-link origin: `https://xdxd.uk/`; the retired `s.patrykw.uk` Tunnel route is pending manual removal |
