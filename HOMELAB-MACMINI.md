...
- Backup coverage: binary, non-secret config, validated SQLite database copy, wrapper, canonical plist, and LaunchAgents plist are included. `secrets.env`, cache, and logs are excluded.
